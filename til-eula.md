...
The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. Recompile LLC, not the Services, is solely responsible for the Licensed Application and the content thereof.

  

This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest [Apple Media Services Terms and Conditions](https://www.apple.com/legal/internet-services/itunes/us/terms.html) ("**Usage Rules**"). Recompile LLC acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.

  

TIL - Today I Learned when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. TIL - Today I Learned is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS").
...
TIL - Today I Learned ("**Licensed Application**") is a piece of software created to Allow users to document the things they learn on a daily basis, with quick and easy lookup. — and customized for iOS mobile devices ("**Devices**"). It is used to document daily tidbits and facts..
...
2.2  You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with Recompile LLC's prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.  

  

2.3  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with Recompile LLC's prior written consent).
...
4.2  Recompile LLC and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.


## 5\. USE OF DATA

You acknowledge that Licensor will be able to access and adjust Your downloaded Licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy, which can be accessed by Clicking the privacy policy link in the applications settings page..
...
9.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of Recompile LLC's sphere of influence that affect the executability of the Licensed Application.

  

9.3  You are required to inspect the Licensed Application immediately after installing it and notify Recompile LLC about issues discovered without delay by email provided in [Contact Information](#contact). The defect report will be taken into consideration and further investigated if it has been emailed within a period of \_\_\_\_\_\_\_\_\_\_ days after discovery.

  

9.4  If we confirm that the Licensed Application is defective, Recompile LLC reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
...
Recompile LLC and the End-User acknowledge that Recompile LLC, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:
...
[contact@recompile.app](mailto:contact@recompile.app)



## 13\. TERMINATION

The license is valid until terminated by Recompile LLC or by You. Your rights under this license will terminate automatically and without notice from Recompile LLC if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.

  

## 14\. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY

Recompile LLC represents and warrants that Recompile LLC will comply with applicable third-party terms of agreement when using Licensed Application.
...
Recompile LLC and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, Recompile LLC, and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.

## 16\. APPLICABLE LAW

This License Agreement is governed by the laws of the State of Utah excluding its conflicts of law rules.
